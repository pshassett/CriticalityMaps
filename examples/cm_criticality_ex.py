...
inp_file = 'Net3.inp' 
_wn = wntr.network.WaterNetworkModel(inp_file)
G = _wn.get_graph()
...
if criticality_type == 'segment':
    ...
    valve_layer = wntr.network.generate_valve_layer(_wn, n=2, seed=123)
    node_segments, link_segments, seg_sizes = wntr.metrics.valve_segments(G, valve_layer)    
    # Run segment criticality analysis
    cm.criticality.segment_criticality_analysis(_wn, link_segments, node_segments, 
                                                valve_layer,
...
if criticality_type == 'pipe':
    ...
    cm.criticality.pipe_criticality_analysis(_wn, 
...
if criticality_type == 'fire':
    ...
    cm.criticality.fire_criticality_analysis(_wn, 
